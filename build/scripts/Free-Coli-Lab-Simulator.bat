...
@rem ##########################################################################
@rem
@rem  Free-Coli-Lab-Simulator startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and FREE_COLI_LAB_SIMULATOR_OPTS to pass JVM options to this script.
...
:fail
rem Set variable FREE_COLI_LAB_SIMULATOR_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%FREE_COLI_LAB_SIMULATOR_EXIT_CONSOLE%" exit 1
exit /b 1
